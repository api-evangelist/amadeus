# Expedia Group (amadeus)
Amadeus for Developers provides a set of APIs for travel booking, search, and management. Access flight search, hotel booking, destination content, and travel intelligence data.

**URL:** [Visit APIs.json URL](https://raw.githubusercontent.com/api-search/travel/main/_apis/expedia-group/apis.md)

## Tags:

 - Airlines, Aviation, Booking, Flights, Hospitality, Hotels, Tourism, Travel
...
- [Terms of Service](https://developers.amadeus.com/legal/terms-of-use)
- [Privacy Policy](https://developers.amadeus.com/legal/privacy-policy)
...
**FN:** Amadeus for Developers Team
